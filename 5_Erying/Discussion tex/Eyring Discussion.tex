...
\item Using these activation parameters, calculate the predicted value of $k_{cat}$ at a selected temperature. Using error-propagation, determine the estimated standard deviation for your results. How was the precision for this value?
